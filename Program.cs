...
namespace Homework_01
{
    class Program
    {
        ...
        static void TaskOne()
        {
            ...
            // Печать в консоль всех сотрудников
            repository.Print("Задание 1. База данных до преобразования");

            // Увольнение всех работников с именем "Агата"
            repository.DeleteWorkerByName("Агата");

            // Печать в консоль сотрудников, которые не попали под увольнение
            repository.Print("Задание 1. База данных после первого преобразования");

            // Увольнение всех работников с именем "Аделина"
            repository.DeleteWorkerByName("Аделина");

            // Печать в консоль сотрудников, которые не попали под увольнение
            repository.Print("Задание 1. База данных после второго преобразования");
        ...
        static void TaskTwo()
        {
            ...
            // Печать в консоль всех сотрудников
            repository.Print("Задание 2. База данных до преобразования");

            // Увольнение всех работников с именем "Агата"
            repository.DeleteWorkerByName("Агата");

            // Печать в консоль сотрудников, которые не попали под увольнение
            repository.Print("Задание 2. База данных после первого преобразования");

            // Увольнение всех работников с именем "Аделина"
            repository.DeleteWorkerByName("Аделина");

            // Печать в консоль сотрудников, которые не попали под увольнение
            repository.Print("Задание 2. База данных после второго преобразования");
        ...
        static void TaskThree()
        {
            ...
            // Печать в консоль всех сотрудников
            repository.Print("Задание 3. База данных до преобразования");

            // Увольнение всех работников чья зарплата больше 30000руб
            repository.DeleteWorkerBySalary(30000);

            // Печать в консоль сотрудников, которые не попали под увольнение
            repository.Print("Задание 3. База данных после первого преобразования");
